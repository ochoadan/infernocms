import type { NormalizedFieldConfig, FieldType } from '../config/types.js';
 ...
 */
export function pgInfoSchemaType(field: NormalizedFieldConfig): string {
  if (field.type === 'number' && field.integer) return 'integer';
 ...
 */
export function pgDdlType(field: NormalizedFieldConfig): string {
