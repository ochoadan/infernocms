...
export declare function registerRoutes(app: FastifyInstance, config: NormalizedConfig, hooks?: HooksMap, access?: AccessMap, auth?: AuthConfig, storage?: StorageDriver, ctx?: AppContext, webhooks?: WebhookConfig[]): Promise<void>;
