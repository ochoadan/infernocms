export type FieldType = 'text' | 'textarea' | 'richtext' | 'number' | 'boolean' | 'select' | 'datetime' | 'date' | 'json' | 'relation' | 'slug' | 'image' | 'file' | 'blocks' | 'link' | 'group' | 'array';
...
export type FieldConfig = TextFieldConfig | TextareaFieldConfig | RichtextFieldConfig | NumberFieldConfig | BooleanFieldConfig | SelectFieldConfig | DatetimeFieldConfig | DateFieldConfig | JsonFieldConfig | RelationFieldConfig | SlugFieldConfig | ImageFieldConfig | FileFieldConfig | BlocksFieldConfig | LinkFieldConfig | GroupFieldConfig | ArrayFieldConfig;
